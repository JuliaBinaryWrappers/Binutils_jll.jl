# Autogenerated wrapper script for Binutils_jll for armv6l-linux-musleabihf
...
JLLWrappers.@declare_library_product(libbfd, "libbfd-2.45.so")
JLLWrappers.@declare_library_product(libctf, "libctf.so.0")
JLLWrappers.@declare_library_product(libopcodes, "libopcodes-2.45.so")
...
JLLWrappers.@declare_executable_product(cxxfilt)
