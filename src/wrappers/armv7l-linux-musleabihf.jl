# Autogenerated wrapper script for Binutils_jll for armv7l-linux-musleabihf
...
JLLWrappers.@declare_library_product(libbfd, "libbfd-2.44.so")
JLLWrappers.@declare_library_product(libctf, "libctf.so.0")
JLLWrappers.@declare_library_product(libopcodes, "libopcodes-2.44.so")
